...
public class AnnotatorUmls extends Annotator{
...
//	UmlsWindow myWindow = null;
	...
	public static final String name = "UMLS";

	private static final Pattern spaces = Pattern.compile("[\\W&&[^']]+|$"); //\\s+
	
	public AnnotatorUmls(UmlsWindow w) {
		super(name, w);
	...
	public static AnnotatorUmls makeAnnotatorInstance(String name, UmlsWindow w) {
		return new AnnotatorUmls(w);
	}
	...
	public static String errInit() {
		ResourceConnectorUmls umls = ResourceConnectorUmls.get();
		...
		String e = "";
		if (badUmls) e += ((e.length() > 0) ? ", " : "") + "UMLS connector";
